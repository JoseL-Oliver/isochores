...
On this website, you can find the coordinates of the isochores predicted by IsoFinder (https://github.com/JoseL-Oliver/isofinder) in complete gap-free human genomes obtained by the Telomere-to-Telomere (T2T) consortium [6]:

Isochores T2T-CHM13: (https://github.com/JoseL-Oliver/isochores/tree/main/T2T-CHM13)
